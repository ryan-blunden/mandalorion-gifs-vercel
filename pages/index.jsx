    ...
    <div className="page-container text-center text-white bg-dark">
        ...
        <div className="container pb-2">
          <div className="row justify-content-center">
            <div className="col text-center">
              <a href="https://doppler.com" target="_blank" rel="noreferrer" className="d-block pt-5">
      ...
      <main>
        <div className="container">
          <div className="row justify-content-center">
            <div className="col">
              <video className="mt-5 shadow-lg rounded position-relative mw-100" muted autoPlay loop>
                ...
                <div className="app-config-secrets">
                  ...
                  {!config.DOPPLER_PROJECT && !config.DOPPLER_CONFIG && (
                    <p className="small alert alert-dark" role="alert">
                      ...
                      <a href="https://docs.doppler.com/docs/vercel" target="_blank" rel="noreferrer">
                        Set up now!
                      </a>
                    </p>
                  )}
